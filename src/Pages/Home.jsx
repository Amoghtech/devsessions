    ...
    <div className={styles.home}>
      <div class='container-md'>
        <div class='row p-2 mt-5'>
          <div class='col d-flex justify-content-center  flex-column p-4'>
            ...
            <h4 class='text-secondary mt-2'>
              DevSessions have Covered You all!
            </h4>
            <h5 class='text-secondary '>
              Stay updated on the all awesome sessions from developers around
              the world!
            </h5>
        ...
        <div class='row '>
          <div class='col d-flex justify-content-center align-items-center p-4'>
            <h1 class='primary-text-color font-weight-bold'>
              Why attend sessions from developers across the world?
            </h1>
          </div>
        </div>
        <div class='row p-2'>
          <div
            class='col d-flex justify-content-center align-items-center shadow m-2 border border-light rounded rounded-3'
            style={{ height: '300px' }}
          >
        ...
        <div class='row '>
          <div class='col d-flex justify-content-center align-items-center p-3 '>
            <h4 class='light-primary-color  rounded shadow  px-3 py-2'>
      ...
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320'>
        <path
          fill='#0099ff'
          fill-opacity='1'
          d='M0,256L120,234.7C240,213,480,171,720,160C960,149,1200,171,1320,181.3L1440,192L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z'
        ></path>
      </svg>
    </div>
  );

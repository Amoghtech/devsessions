      ...
      <div class="container-md">
        <div class="row p-2 mt-5">
          <div class="col d-flex justify-content-center  flex-column p-4">
            ...
            <h1 style={{ width: '10rem' }}><button type="button" class="btn btn-outline-primary  mt-3 font-weight-bold" onClick={registerhandler} >Register!</button></h1>
          </div>
        ...
        <div class="row p-2 mt-5">
          ...
          <div class="col d-flex justify-content-center flex-column p-4">
            ...
            <h1 style={{ width: '10rem' }}><button type="button" onClick={workshopshandler} class="btn btn-outline-primary  mt-3 font-weight-bold" >Check out All!</button></h1>
          </div>
        </div>
        <div class="row p-2 mt-5 ">
